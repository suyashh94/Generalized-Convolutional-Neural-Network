...
for iter = 1:500
    for k = 1:10%length(X_minibatch)
        ...
        [A, Z, max_mask] = Conv_forward_prop_dropout(X,conv_layer_name,filt,bias,s_x,s_y,s,toKeep_matrix,keep_prob);
        ...
        [dA, dZ, dFilt, dBias] = Conv_back_prop_dropout(dZ,Z,A,X,filt,s_x,s_y,s,conv_layer_name,max_mask,toKeep_matrix,keep_prob);
